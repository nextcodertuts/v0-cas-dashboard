...
import { UserPlus, CreditCard, Users, FileText } from "lucide-react"
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>Cards expiring in the next 30 days</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">No upcoming expirations to display.</p>
              </CardContent>
            </Card>
          </div>
        </TabsContent>
